...
public class UserController {
    ...
    @QueryMapping
    public List<User> list(@Argument String userName,@Argument Integer page,@Argument Integer pageSize) {
        return userRepository.findUserByUserNameStartingWith(userName, PageRequest.of(page, pageSize));
    }
